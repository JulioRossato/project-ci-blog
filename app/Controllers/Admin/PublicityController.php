...
/**
 * Description of PublicityController
 *
 * @author Júlio Rossato <WWW.JULIOROSSATO.COM.BR>
 */
class PublicityController extends \App\Controllers\BaseController
{
    public $module = 'Publicidade';
    ...
    public function add()
    {
        ...
        $data['page_module']     = $this->module;
        $data['page_title']      = 'Adicionar Publicidade';
        $data['page_controller'] = (new \ReflectionClass(__CLASS__))->getShortName();
        $data['page_method']     = __FUNCTION__;

        # =================================
        $data['action']    = base_url('/admin/publicity/save');
        $data['page_list'] = (new \App\Models\PublicityModel)->getFields();
    ...
    public function edit($id = null)
    {
        ...
        $data['page_module']     = $this->module;
        $data['page_title']      = 'Editar Publicidade';
        $data['page_controller'] = (new \ReflectionClass(__CLASS__))->getShortName();
        $data['page_method']     = __FUNCTION__;
        ...
        $find = (new \App\Models\PublicityModel)->where(['id' => $id])->asArray()->first();
    ...
    public function save()
    {
        ...
        $Model = new \App\Models\PublicityModel();
        ...
        return redirect()->to('/admin/publicity')->with('response', $response);
    }
