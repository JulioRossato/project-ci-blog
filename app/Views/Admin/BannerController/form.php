                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 text-end align-self-center align-middle">
                                <a href="/admin/banner" class="btn btn-primary btn-sm"><i class="fa-solid fa-list"></i> Listar</a>
                            </div>
                        </div>
                        <form action="<?= $action; ?>" method="POST" enctype="multipart/form-data" data-module="<?= $page_controller; ?>">
                            ...
                            <div class="row mb-3">
                                <label for="content" class="col-sm-2 col-form-label">Conteúdo <span class='text-danger text-xs'>*</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="imageMobile" class="col-sm-2 col-form-label">Banner Mobile</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <button
                                            type="button"
