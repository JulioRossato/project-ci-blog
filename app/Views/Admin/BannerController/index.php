                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            <div class="col-md-6 align-self-center align-middle">
                                <h5 class="card-title"><i class="fa-solid fa-slist"></i> Lista de banners</h5>
                            </div>
                            <div class="col-md-6 text-end align-self-center align-middle">
                                <a href="/admin/banner/add" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Cadastrar</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="name" data-sortable="true">TITULO</th>
                                        <th data-field="rowOrder" data-sortable="true">ORDEM</th>
                                        <th data-field="statusCode" data-sortable="true" data-visible="false">STATUS</th>
