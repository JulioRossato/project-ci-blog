                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 text-end align-self-center align-middle">
                                <a href="/admin/publicity" class="btn btn-primary btn-sm"><i class="fa-solid fa-list"></i> Listar</a>
                            </div>
                        </div>
                        <form action="<?= $action; ?>" method="POST" enctype="multipart/form-data" data-module="<?= $page_controller; ?>">
                            ...
                            <div class="row mb-3">
                                <label for="statusCode" class="col-form-label col-sm-2">Dimenção</label>
                                <div class="col-sm-10">
                                    <?php
                                    $option = [
                                        '720x120' => '720x120',
                                    ...
                                    echo form_dropdown('dimensions', $option,
                                        $page_list['dimensions'],
                                        'class="form-select"');
                                    ?>
                                </div>
                            </div>
