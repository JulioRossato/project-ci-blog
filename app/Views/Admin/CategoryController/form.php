                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 text-end align-self-center align-middle">
                                <a href="/admin/category" class="btn btn-primary btn-sm"><i class="fa-solid fa-list"></i> Listar</a>
                            </div>
                        </div>
                        <form action="<?= $action; ?>" method="POST" enctype="multipart/form-data" data-module="<?= $page_controller; ?>">
                            ...
                            <div class="row mb-3">
                                <label for="name" class="col-sm-2 col-form-label">Nome <span class='text-danger text-xs'>*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" id="name" value="<?= $page_list['name']; ?>" placeholder="Nome da categoria" required>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="parentId" class="col-sm-2 col-form-label">Categoria pai</label>
                                <div class="col-sm-10">
                                    <select class="form-select select2" name="parentId" data-placeholder="Selecione a categoria pai em casos de subcategoria">
                                        <option value=""></option>
                                        <?php
                                        foreach ($category_list as $categ) :
                                            if ($categ['id'] == $page_list['id']) :
                                                continue;
                                            endif;
                                            ?>
                                            <option value="<?= $categ['id']; ?>" <?=
                                            ($categ['id'] != $page_list['parentId'])
                                                    ?: "selected"
                                            ?>><?= $categ['name']; ?></option>
                                                <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <label for="image" class="col-sm-2 col-form-label">Imagem <span class='text-danger text-xs'>*</span></label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="imageMobile" class="col-sm-2 col-form-label">Imagem Mobile <span class='text-danger text-xs'>*</span></label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <button
                                            type="button"
