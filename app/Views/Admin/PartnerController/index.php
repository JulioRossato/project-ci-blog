                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            <div class="col-md-6 align-self-center align-middle">
                                <h5 class="card-title"><i class="fa-solid fa-slist"></i> Lista de parceiros</h5>
                            </div>
                            <div class="col-md-6 text-end align-self-center align-middle">
                                <a href="/admin/partner/add" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Cadastrar</a>
                            </div>
                        </div>
